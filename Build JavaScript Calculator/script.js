...
function Calculator(props){
 ...
 //OPERATION EVENT HANDLER ---------------------------------------------------- 
  ...
  const handleNumber = (e) => {
   ...
   //If its not reseted, you can keep adding numbers to build a one-or-more-digit single number
   if(isReseted == false)
   {
   ...
   //This condition keeps a number from starting with 0 by clicking the button (you can still start with 0 if you add a decimal point or perform an operation on the default initial value, which is 0)
